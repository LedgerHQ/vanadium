//! Build script: generates the cleartext support files from `src/bip388/cleartext/specs/cleartext.toml`.
//!
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let spec_path =
        PathBuf::from(&manifest_dir).join("src/bip388/cleartext/specs/cleartext.toml");
